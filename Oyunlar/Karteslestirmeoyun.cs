...
namespace OYUN.Oyunlar
{
    ...
    public partial class Karteslestirmeoyun : Form
    {
        ...
        {
            Karteslestirmetanıtım karteslestirmetanıtım = new Karteslestirmetanıtım();
            timer1.Stop();
            karteslestirmetanıtım.FormClosed += (s, args) =>
            {
                timer1.Start(); // Timer yeniden başlar.
            };
            karteslestirmetanıtım.Show();
        }
