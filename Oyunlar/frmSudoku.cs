...
namespace FirstPlei
{
     ...
     */
        ...
        private void btnComecar_Click(object sender, EventArgs e)
        {
            ...
            if (txtNome.Text == "Numara Girin" || txtNome.Text == "")
            {
                lblInfo.Text = "Lütfen numara giriniz.";
            ...
            else
            {
                ...
                lblInfo.Text = "Oyun Şeçiniz " + txtNome.Text;
        ...
        private void btnLimpar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogResult = MessageBox.Show("Sayıları temizlemek istiyor musunuz?", "Sayıları temizleyiniz.", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (dialogResult == DialogResult.Yes)
            {

                lblInfo.Text = "Sayıları temizleyin. İyi şanlar!";
                lblInfo.BackColor = Color.WhiteSmoke;
        ...
        private void btnNovo_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogResult = MessageBox.Show("Yeni bir oyuna mı başlamak istiyorsunuz (yoksa mevcut oyun kaybolacak mı)?", "Yeni oyun", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (dialogResult == DialogResult.Yes)
            {

                lblInfo.Text = "Yeni oyununuzu yapılandırın ve oynamaya başlayın!";
                lblInfo.BackColor = Color.WhiteSmoke;
        ...
        private void btnAnotar_Click(object sender, EventArgs e)
        {
            ...
            if (btnAnotar.Text == "Olaslıkları Yazın")
            {

                lblInfo.Text = "Olası Sayıları Giriniz";
                lblInfo.BackColor = Color.WhiteSmoke;
                btnAnotar.Text = "Puanlamayı Bırak";
                btnAcabei.Enabled = false;
                btnComoEstou.Enabled = false;
                btnLimpar.Enabled = false;
                btnNovo.Enabled = false;
            ...
            else
            {
                ...
                lblInfo.Text = "Şu Oyundasınız " + txtNome.Text;
                btnAnotar.Text = "Olasılıkları yazın";
                lblInfo.BackColor = Color.WhiteSmoke;
                btnAcabei.Enabled = true;
                btnComoEstou.Enabled = true;
                btnLimpar.Enabled = true;
        ...
        private void btnComoEstou_Click(object sender, EventArgs e)
        {
            ...
            numComoEstou--;
            btnComoEstou.Text = "Kontrol Et (" + numComoEstou + ")";
            ...
            lblInfo.Text = errosComoEstou + "hatalar, " + vazioComoEstou + "boş alanlar.";
            lblInfo.BackColor = Color.WhiteSmoke;
        ...
        private void btnAcabei_Click(object sender, EventArgs e)
        {
            ...
            )
            {
                ...
                if (vitoria == true)
                {
                    ...
                    lblInfo.Text = "Tebrikler, kazandınız!";
                ...
                else
                {
                    ...
                    lblInfo.Text = "Ne yazık ki hala hatalar var!";
                    lblInfo.BackColor = Color.FromArgb(253, 108, 108);
            ...
            else
            {
                ...
                lblInfo.Text = "Lütfen tüm alanları doldurun!";
                lblInfo.BackColor = Color.FromArgb(253, 108, 108);
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Menüye geri dönmek istediğinizden emin misiniz? Oyununuz kaybedilecek!", "Menüye dön", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (dialogResult == DialogResult.Yes)
            {
